...
// ── Helpers ─────────────────────────────────────────────────────────
function rejectBoth(args) {
    if (args.markdown && args.html) {
        throw new Error("Provide either 'markdown' OR 'html' for page content, not both. Markdown is recommended since BookStack converts it to HTML automatically.");
    }
}
...
export function createTools(client) {
    return [
        ...
        },
        {
            ...
            handler: async (args) => client.getBook(args.id),
        },
        {
        ...
        },
        {
            ...
            handler: async (args) => client.updateBook(args.id, {
                name: args.name,
                description: args.description,
                tags: cleanTags(args.tags),
            }),
        ...
        },
        {
            ...
            handler: async (args) => client.exportBook(args.id, args.format || "markdown"),
        },
        // ═══ Chapters ════════════════════════════════════════════════
        {
        ...
        },
        {
            ...
            handler: async (args) => client.getChapter(args.id),
        },
        {
        ...
        },
        {
            ...
            handler: async (args) => client.updateChapter(args.id, {
                book_id: args.book_id,
                name: args.name,
                description: args.description,
                tags: cleanTags(args.tags),
        ...
        },
        {
            ...
            handler: async (args) => client.exportChapter(args.id, args.format || "markdown"),
        },
        // ═══ Pages ═══════════════════════════════════════════════════
        {
        ...
        },
        {
            ...
            handler: async (args) => client.getPage(args.id),
        },
        {
            name: "bookstack_create_page",
            description: "Create a new page. Provide content in markdown (recommended) OR html, not both. " +
        ...
        },
        {
            ...
            description: "Update a page's content or metadata. Provide markdown (recommended) OR html, not both. " +
            ...
            handler: async (args) => {
                ...
                const md = args.markdown;
                const rawHtml = args.html;
                return client.updatePage(args.id, {
                    book_id: args.book_id,
                    chapter_id: args.chapter_id,
                    name: args.name,
                    markdown: md,
        ...
        },
        {
            ...
            handler: async (args) => client.exportPage(args.id, args.format || "markdown"),
        },
        // ═══ Shelves ═════════════════════════════════════════════════
        {
        ...
        },
        {
            ...
            handler: async (args) => client.getShelf(args.id),
        },
        {
        ...
        },
        {
            ...
            handler: async (args) => client.updateShelf(args.id, {
                name: args.name,
                description: args.description,
                tags: cleanTags(args.tags),
                books: args.books,
        ...
        },
        {
            ...
            handler: async (args) => {
                await client.deleteShelf(args.id);
                return { success: true, deleted_id: args.id };
            },
        },
        // ═══ Search & System ═════════════════════════════════════════
