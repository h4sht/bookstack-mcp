...
export interface BookWithContents extends Book {
  contents: Array<
    | { type: "chapter"; id: number; name: string; slug: string; priority: number; pages: Array<{ id: number; name: string; slug: string; priority: number; draft: boolean; template: boolean }> }
    | { type: "page"; id: number; name: string; slug: string; priority: number; draft: boolean; template: boolean }
  >;
}
